...
public sealed class PlaybackTransportControllerTests
{
    ...
    private sealed class FakePlaybackService(PlaybackState initialState, TimeSpan initialPosition) : IPlaybackService
    {
        ...
        public Task LoadAsync(string filePath, PlaybackState initialState = PlaybackState.Stopped, CancellationToken cancellationToken = default) { cancellationToken.ThrowIfCancellationRequested(); LoadCalls++; Position = TimeSpan.Zero; SetState(initialState); return Task.CompletedTask; }
